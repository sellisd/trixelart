...
image = open_image_from_url("https://classroomclipart.com/image/static7/preview2/cute-playful-smiling-horse-clip-art-57263.jpg")

pixelated_img = pixelate_image_with_right_triangles(image, 30)
pixelated_img.show()
pixelated_img.save('pixelated_image_with_triangles.png')  # To save the image